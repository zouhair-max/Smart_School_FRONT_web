// src/components/SuperAdminDashboard/components/Modal/UsersModal.jsx
import React, { useEffect, useState } from 'react'
import axios from 'axios'
import { useAuth } from '../../../../context/AuthContext'
import { X, Plus, Edit2, Trash2, Users, Mail, Phone, Search, School, Shield, User, Menu, Filter } from 'lucide-react'
...
export default function UsersModal() {
  ...
  // Search filter - searches in name, email, and phone
  ...
  const getRoleIcon = (role) => {
    if (role === 'super_admin' || role === 'school_admin') return Shield
              ...
              <div className="overflow-x-auto">
                ...
                <div className="lg:hidden">
                  {filteredUsers.map((user) => {
                    ...
                    return (
                      <div key={user.id} className="p-4 border-b border-gray-200 hover:bg-gray-50 transition-colors">
                      ...
                      return (
                        <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-4 lg:px-6 py-3 lg:py-4">
                            <div className="flex items-center gap-2 text-gray-600">
                              <School className="w-4 h-4 text-gray-400 flex-shrink-0" />
                              <span className="text-sm truncate max-w-[200px]">{user.school?.name || '-'}</span>
                            </div>
                          </td>
                          <td className="px-4 lg:px-6 py-3 lg:py-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Leave empty if not assigned to any school
                      </p>
                    </div>
                  </div>
                </div>
